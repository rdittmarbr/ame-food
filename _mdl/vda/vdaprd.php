...
$aModule['form']['form']      = 'vdaprd.html';   // Nome do arquivo HTML (False para não carregar nenhum formulario
$aModule['form']['container'] = 'body';               // Container do formulario
$aModule['js']['before']      = 'body.clearChild;gl_Desktop.setURL("?vdaprd")';   // limpando os containers
$aModule['js']['after']      = '';
